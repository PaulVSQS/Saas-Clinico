...
/// <see cref="Consultar"/> desde Application (Where/Include/OrderBy). Si en Fase 6 algún módulo
/// necesita una consulta imposible de expresar así (ej. SQL crudo con hints de rendimiento),
/// la solución es agregar una interfaz específica en Application que herede de
/// <see cref="IRepositorio{TEntity}"/> (ej. IPacienteRepositorio) con el método adicional, e
/// implementarla en este mismo namespace heredando de esta clase — no reescribir el CRUD base.
/// </summary>
