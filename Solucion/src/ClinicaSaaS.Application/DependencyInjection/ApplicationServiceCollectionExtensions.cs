...
/// Fase 6: un servicio por módulo de negocio — Clínicas, Usuarios, Empleados, Doctores, y los
/// que sigan). Mismo patrón que AddInfrastructure()/AddPersistence() — Program.cs no debe
/// conocer las clases concretas de este proyecto, solo llamar builder.Services.AddApplication().
/// </summary>
